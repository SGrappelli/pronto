    ...
    <div className={`${styles.page} ${bricolage.variable} ${dmSans.variable}`}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerLinks}>
          ...
          <TrackedAnchor href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" eventName="github_click" eventParams={{ label: 'footer_link', page: '/es' }}>
            GitHub
          </TrackedAnchor>
        </div>
      </footer>
