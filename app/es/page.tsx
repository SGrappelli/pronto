    ...
    <div className={`${styles.page} ${bricolage.variable} ${dmSans.variable}`}>
      ...
      <footer className={styles.footerGridWrap}>
        <div className={styles.footerGrid}>
          <div>
            <Link href="/es/" style={{fontSize:'22px',fontWeight:800,color:'#111',letterSpacing:'-0.5px',textDecoration:'none'}}>Pronto<span style={{color:'#16a34a'}}>.</span></Link>
          ...
          <div>
            ...
            <Link href="/es/blog" style={{display:'block',fontSize:'14px',color:'#6b7280',textDecoration:'none',marginBottom:'10px'}}>Blog</Link>
          </div>
          <div>
          ...
          <div>
            ...
            <Link href="/terms" style={{display:'block',fontSize:'14px',color:'#6b7280',textDecoration:'none',marginBottom:'10px'}}>Términos de uso</Link>
            <Link href="/privacy" style={{display:'block',fontSize:'14px',color:'#6b7280',textDecoration:'none',marginBottom:'10px'}}>Privacidad</Link>
            <Link href="/refund" style={{display:'block',fontSize:'14px',color:'#6b7280',textDecoration:'none',marginBottom:'10px'}}>Reembolsos</Link>
          </div>
        </div>
