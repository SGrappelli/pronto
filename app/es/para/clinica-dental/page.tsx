...
<nav>
  ...
  <div class="nav-right">
    ...
    <a href="/for/dental" class="nav-link lang-switcher">EN</a>
    <a href="/login" class="nav-link">Iniciar sesi&oacute;n</a>
    <a href="https://app.trypronto.app/register" class="btn-nav">Empezar gratis</a>
  </div>
</nav>
...
<section class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-ctas">
      <a href="https://app.trypronto.app/register" class="btn-primary">Empezar gratis</a>
...
<section class="sec sec-white">
  ...
  <div class="two-paths">
    ...
    <div class="path-card cloud">
      ...
      <a href="https://app.trypronto.app/register" class="btn-primary">Empezar gratis &rarr;</a>
    </div>
  </div>
</section>
...
<section class="cta-band">
  ...
  <div>
    <a href="https://app.trypronto.app/register" class="btn-cta-white">Crear cuenta gratis</a>
...
export default function EsParaClinicaDentalPage() {
  return (
    <>
      <AnalyticsListener page="/es/para/clinica-dental" />
      <script
