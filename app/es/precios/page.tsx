    ...
    <div className={`${styles.page} ${bricolage.variable} ${dmSans.variable}`}>
            ...
            <div className="mt-20 text-center bg-gray-50 rounded-2xl px-8 py-14 border border-gray-200">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <TrackedAnchor
                  ...
                  eventName="cta_click"
                  eventParams={{ label: 'start_free', page: '/es/precios' }}
                >
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerSocial}>
          ...
          <TrackedAnchor href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on GitHub" eventName="github_click" eventParams={{ label: 'footer_link', page: '/es/precios' }}>
