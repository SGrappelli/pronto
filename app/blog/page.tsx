...
export const metadata: Metadata = {
  title: 'Pronto Blog — POS & Booking Guides for Service Business',
  description:
    'Practical guides on POS systems, appointment booking, and running a service business without paying commissions to platforms like Fresha or Booksy.',
  alternates: {
    canonical: 'https://trypronto.app/blog',
    languages: {
  ...
  openGraph: {
    type: 'website',
    url: 'https://trypronto.app/blog',
    title: 'Pronto Blog — POS & Booking Guides for Service Business',
    description:
      'Practical guides on POS systems, appointment booking, and running a service business without commissions.',
...
export default function BlogIndexPage() {
  ...
  const cards = posts.map(post => `
    <a href="/blog/${post.slug}" class="post-card">
      ...
      <div class="post-meta">${formatDate(post.date)} &middot; ${post.readingTime} min read</div>
      <span class="post-readmore">Read more &rarr;</span>
    </a>
  `).join('')
...
<nav>
  ...
  <div class="nav-right">
    ...
    <a href="/register" class="btn-nav" onclick="window.gtag&&window.gtag('event','sign_up_click',{label:'start_free',page:'/blog'})">Start free</a>
  </div>
</nav>

<section class="blog-hero">
  <h1>The Pronto Blog</h1>
  <p>Practical guides on POS, appointment booking, and running a service business without paying commissions to someone else.</p>
</section>
