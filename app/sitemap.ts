...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return walkPages(appDir)
    ...
    .map(({ route }) => ({
      url: `${BASE_URL}${route}`,
      changeFrequency: (['/', '/es', '/pt', '/for', '/for/salons', '/es/para', '/es/para/salones', '/for/barbershops', '/es/para/barberia', '/for/auto-repair', '/es/para/autoservicio', '/es/para/clinica-dental', '/docs', '/es/docs', '/pt/docs'].includes(route) ? 'weekly' : 'monthly') as MetadataRoute.Sitemap[number]['changeFrequency'],
