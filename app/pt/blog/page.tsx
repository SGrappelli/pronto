...
export const metadata: Metadata = {
  title: 'Blog do Pronto — Guias de POS e Gestão para Negócios',
  description:
    'Guias práticos sobre sistemas PDV, gestão de agendamentos e como operar um negócio de serviços sem pagar comissões a plataformas como Fresha ou Booksy.',
  alternates: {
    canonical: 'https://trypronto.app/pt/blog',
    languages: {
  ...
  openGraph: {
    type: 'website',
    url: 'https://trypronto.app/pt/blog',
    title: 'Blog do Pronto — Guias de POS e Gestão para Negócios',
    description:
      'Guias práticos sobre PDV, agendamentos e operação de negócios de serviços sem comissões.',
...
export default function PtBlogIndexPage() {
  ...
  const cards = posts.map(post => `
    <a href="/pt/blog/${post.slug}" class="post-card">
      <span class="post-tag">${post.category}</span>
      <h2>${post.title}</h2>
      <p>${post.description}</p>
      <div class="post-meta">${formatDate(post.date)} &middot; ${post.readingTime} min de leitura</div>
      <span class="post-readmore">Ler mais &rarr;</span>
    </a>
  `).join('')
...
<nav>
  ...
  <div class="nav-right">
    <a href="/pt/blog" class="nav-link hide-mob">Blog</a>
    <a href="/pt/precos" class="nav-link hide-mob">Pre&ccedil;os</a>
    ...
    <a href="/register" class="btn-nav" onclick="window.gtag&&window.gtag('event','sign_up_click',{label:'start_free',page:'/pt/blog'})">Comece gr&aacute;tis</a>
  </div>
</nav>

<section class="blog-hero">
  <h1>O Blog do Pronto</h1>
  <p>Guias pr&aacute;ticos sobre PDV, gest&atilde;o de agendamentos e como operar um neg&oacute;cio de servi&ccedil;os sem pagar comiss&otilde;es a plataformas externas.</p>
</section>
...
<footer>
  <div class="footer-top">
    ...
    <div class="footer-col">
      ...
      <a href="/refund">Reembolso</a>
    </div>
  </div>
  <div class="footer-bottom">
    <div class="footer-copy">&copy; 2026 Pronto. Todos os direitos reservados.</div>
    <div class="footer-social">
      <a href="https://x.com/prontopos" target="_blank" rel="noopener noreferrer" aria-label="Pronto no X"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.76l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
      <a href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto no GitHub"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
    </div>
  </div>
</footer>
`
