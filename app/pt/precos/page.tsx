        ...
        <div className="py-16 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-center text-base font-medium text-gray-700 mt-4">
              ...
              <Link href="/pt/vs/" className="text-blue-600 hover:text-blue-800 underline underline-offset-2">
      ...
      <footer className={styles.footerGridWrap}>
        <div className={styles.footerGrid}>
          ...
          <div>
            ...
            <Link href="/terms" style={{ display: 'block', fontSize: '14px', color: '#6b7280', textDecoration: 'none', marginBottom: '10px' }}>Termos de Serviço</Link>
        ...
        <div className={styles.footerGridBottom}>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <TrackedAnchor href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on GitHub" eventName="github_click" eventParams={{ label: 'footer_link', page: '/pt/precos' }} style={{ color: '#9ca3af', display: 'flex', lineHeight: '1', textDecoration: 'none' }}>
