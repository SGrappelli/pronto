...
<nav>
  ...
  <div class="nav-right">
    ...
    <a href="/register" class="btn-nav" onclick="window.gtag&&window.gtag('event','cta_click',{label:'start_free',page:'/pt/para/auto-repair'})">Come&ccedil;ar gr&aacute;tis</a>
  </div>
</nav>
...
<section class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-ctas">
      <a href="/register" class="btn-primary" onclick="window.gtag&&window.gtag('event','cta_click',{label:'start_free',page:'/pt/para/auto-repair'})">Come&ccedil;ar gr&aacute;tis &rarr;</a>
...
<section class="sec sec-white">
  ...
  <div class="plans">
    <div class="plan">
      ...
      <a href="/register" class="plan-cta" onclick="window.gtag&&window.gtag('event','cta_click',{label:'free_plan',page:'/pt/para/auto-repair'})">Come&ccedil;ar gr&aacute;tis</a>
    </div>
    <div class="plan">
      ...
      <a href="/register" class="plan-cta" onclick="window.gtag&&window.gtag('event','cta_click',{label:'starter_plan',page:'/pt/para/auto-repair'})">Come&ccedil;ar agora</a>
    </div>
    <div class="plan featured">
      ...
      <a href="/register" class="plan-cta" onclick="window.gtag&&window.gtag('event','cta_click',{label:'pro_plan',page:'/pt/para/auto-repair'})">Come&ccedil;ar agora</a>
    </div>
    <div class="plan">
      ...
      <a href="/register" class="plan-cta" onclick="window.gtag&&window.gtag('event','cta_click',{label:'agency_plan',page:'/pt/para/auto-repair'})">Come&ccedil;ar agora</a>
    </div>
  </div>
...
<section class="cta-band">
  ...
  <div>
    <a href="/register" class="btn-cta-white" onclick="window.gtag&&window.gtag('event','cta_click',{label:'start_free',page:'/pt/para/auto-repair'})">Come&ccedil;ar gr&aacute;tis &rarr;</a>
