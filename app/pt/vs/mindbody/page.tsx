...
export const metadata: Metadata = {
  title: 'Pronto vs Mindbody — sem contratos, sem complexidade',
  description:
    'Pronto vs Mindbody: plano grátis vs $99-$139/mês + contrato de 1-2 anos. Sem comissão vs 20% marketplace. Self-hosted vs somente na nuvem. Veja qual é melhor.',
  alternates: {
    canonical: 'https://trypronto.app/pt/vs/mindbody',
    languages: {
  ...
  openGraph: {
    type: 'website',
    url: 'https://trypronto.app/pt/vs/mindbody',
    title: 'Pronto vs Mindbody — sem contratos, sem complexidade',
    description:
      'Plano grátis vs $99-$139/mês + contrato de 1-2 anos. Sem comissão vs 20% marketplace. Self-hosted vs somente na nuvem.',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'O Pronto é uma alternativa gratuita ao Mindbody?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sim. O Pronto tem um plano gratuito sem mensalidade e sem comissão. O Mindbody não oferece plano gratuito nem período de teste — o plano Starter começa em aproximadamente $99-$139/mês por local, exigindo um contrato de 12 a 24 meses.',
      },
    },
    {
      '@type': 'Question',
      name: 'O Mindbody cobra comissão?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sim. O Mindbody cobra 20% de comissão sobre agendamentos feitos pelo seu marketplace de consumidores, com um teto de $30 por cliente. O Pronto cobra zero comissão em qualquer caso — seja pelo SaaS em trypronto.app ou pela versão self-hosted.',
      },
    },
    {
      '@type': 'Question',
      name: 'O Mindbody exige contrato?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sim. O Mindbody geralmente exige contratos anuais de 12 a 24 meses. Cancelar antes do término pode gerar multas. O Pronto não tem contratos — você cancela a qualquer momento sem penalidade.',
      },
    },
    {
      '@type': 'Question',
      name: 'Quanto custa o Mindbody por mês?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O Mindbody Starter custa aproximadamente $99-$139/mês por local, com contrato anual. Funcionalidades avançadas como o assistente de IA Messenger custam $75-$250/mês adicionais. O processamento de pagamentos custa 2,99%-3,60%+$0,30 por transação. O Pronto começa em $0/mês — o plano Pro cobre 15 funcionários por $39/mês fixo.',
      },
    },
    {
      '@type': 'Question',
      name: 'O Pronto tem notificações por WhatsApp como o Mindbody?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O Mindbody não oferece notificações nativas por WhatsApp ou Telegram. O Pronto inclui notificações nativas por WhatsApp, Telegram, Viber e E-mail sem custo adicional: confirmação de agendamento, lembrete 24h antes, lembrete 1h antes, mensagem pós-visita e reativação de clientes.',
      },
    },
    {
      '@type': 'Question',
      name: 'Existe uma alternativa self-hosted ao Mindbody?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sim. O Pronto é a única alternativa open-source e self-hosted ao Mindbody. Instale com um único comando no seu próprio servidor: docker compose up -d. Os dados dos seus clientes ficam no seu servidor — não na nuvem do Mindbody. O Pronto tem licença MIT.',
      },
    },
    {
      '@type': 'Question',
      name: 'Onde o Mindbody tem vantagem sobre o Pronto?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'O Mindbody tem um grande marketplace de consumidores, especialmente forte no segmento de fitness e bem-estar nos EUA, além de funcionalidades avançadas para estúdios como gestão de aulas em grupo, assinaturas e integração com wearables. Para grandes estúdios de fitness que precisam dessas funcionalidades específicas, o Mindbody pode valer o custo mais alto.',
      },
    },
    {
      '@type': 'Question',
      name: 'Posso migrar do Mindbody para o Pronto?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Sim. Exporte sua lista de clientes do Mindbody e importe para o CRM do Pronto. Você pode usar os dois em paralelo durante a transição. O SaaS do Pronto em trypronto.app leva minutos para configurar, ou instale no seu próprio servidor com um único comando.',
      },
    },
  ],
}
...
const softwareAppSchema = {
  ...
  description:
    'Alternativa gratuita e open-source ao Mindbody para salões, barbearias e estúdios de fitness. Sem contratos, zero comissão, notificações nativas por WhatsApp e Telegram, opção self-hosted.',
  alternateName: [
    'alternativa gratuita ao Mindbody',
    'alternativa open source ao Mindbody',
    'alternativa self-hosted ao Mindbody',
    'alternativa ao Mindbody sem contrato',
    'alternativa ao Mindbody com WhatsApp',
    'alternativa ao Mindbody para salões',
  ],
}
...
<nav>
  ...
  <div class="nav-right">
    <a href="/pt/precos" class="nav-link hide-mob" onclick="window.gtag&&window.gtag('event','pricing_click',{source:'/pt/vs/mindbody'})">Pre&ccedil;os</a>
    ...
    <select aria-label="Language" style="font-size:0.85rem;font-family:inherit;font-weight:500;border:1px solid #d1d5db;border-radius:6px;padding:4px 6px;background:transparent;cursor:pointer;color:inherit;appearance:none;-webkit-appearance:none;min-width:52px;" onchange="var m={en:'/vs/mindbody',es:'/es/vs/mindbody'};if(m[this.value])location.href=m[this.value]"><option value="en">EN</option><option value="es">ES</option><option value="pt" selected>PT</option></select>
...
<section class="hero">
  <h1>Pronto vs Mindbody &mdash; sem contratos, sem complexidade</h1>
  <p>O Mindbody come&ccedil;a em ~$99-$139/m&ecirc;s por local com contrato de 12-24 meses &mdash; sem plano gratuito, sem teste. O Pronto tem plano gratuito para sempre, sem contrato, sem comiss&atilde;o. Configure em minutos.</p>
  <div class="hero-btns">
  ...
  <div class="hero-pills">
    ...
    <span class="hero-pill">&#10003; Sem contratos</span>
  ...
  <div class="verdict-inner">
    ...
    <div class="verdict-cols">
      <div class="verdict-col">
        ...
        <div class="verdict-item yes">&#10003; N&atilde;o quer assinar contrato anual</div>
        ...
        <div class="verdict-item yes">&#10003; N&atilde;o precisa de marketplace de fitness dos EUA</div>
      </div>
      <div class="verdict-col">
        <h3>Escolha o Mindbody se&hellip;</h3>
        <div class="verdict-item no">&rarr; Gere aulas em grupo, assinaturas e pacotes de sess&otilde;es em grande escala</div>
        <div class="verdict-item no">&rarr; Quer acesso ao marketplace de consumidores fitness do Mindbody</div>
        <div class="verdict-item no">&rarr; Precisa de integra&ccedil;&atilde;o avan&ccedil;ada com wearables e plataformas de fitness</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="comp-inner">
    ...
    <div class="table-wrap">
      <table>
        ...
        <tbody>
          <tr><td>Mensalidade base</td><td class="green">$0 plano gratuito</td><td class="red">~$99-$139/m&ecirc;s (sem plano gr&aacute;tis)</td></tr>
          <tr><td>Plano gratuito / teste</td><td class="green">&#10003; Plano gratuito para sempre</td><td class="red">&#10007; Nenhum</td></tr>
          <tr><td>Contratos</td><td class="green">&#10003; Sem contratos &mdash; cancele quando quiser</td><td class="red">12-24 meses obrigat&oacute;rios</td></tr>
          <tr><td>Comiss&atilde;o marketplace</td><td class="green">0% sempre</td><td class="red">20% por agendamento (m&aacute;x. $30/cliente)</td></tr>
          <tr><td>Processamento de pagamentos</td><td class="red">&#10007;</td><td>2,99%-3,60% + $0,30/transa&ccedil;&atilde;o</td></tr>
          <tr><td>Assistente de IA de agendamento</td><td class="green">&#10003; Inclu&iacute;do</td><td class="red">Add-on pago ~$75-$250/m&ecirc;s</td></tr>
          ...
          <tr><td>Exporta&ccedil;&atilde;o de dados</td><td class="green">&#10003; Total &mdash; seus dados, seu servidor</td><td>&#9888;&#65039; Limitada nos planos mais baixos</td></tr>
          ...
          <tr><td>Marketplace de consumidores</td><td class="red">&#10007;</td><td class="green">&#10003; Fitness/bem-estar nos EUA</td></tr>
        </tbody>
      </table>
    </div>
    <div class="table-hint">&#8592; Deslize para comparar &#8594;</div>
    <div class="table-note">O Mindbody n&atilde;o divulga seus pre&ccedil;os completos publicamente. Os valores refletem dados reportados por usu&aacute;rios e pesquisas de terceiros de maio de 2026. Verifique as tarifas atuais diretamente com a equipe de vendas do Mindbody.</div>
  </div>
</section>

<section class="pain-section">
  <div class="pain-inner">
    <h2>O que propriet&aacute;rios de neg&oacute;cios dizem sobre o Mindbody</h2>
    <div class="pain-grid">

      <div class="pain-card">
        <span class="pain-icon">&#x1F4DC;</span>
        <h3>Contratos de 12-24 meses sem sa&iacute;da f&aacute;cil</h3>
        <p>O Mindbody exige contratos anuais longos. Se o seu neg&oacute;cio mudar de dire&ccedil;&atilde;o ou o software n&atilde;o atender &agrave;s suas necessidades, voc&ecirc; ainda paga pelos meses restantes. O Pronto n&atilde;o tem contratos &mdash; cancele a qualquer momento, sem penalidades.</p>
      </div>

      <div class="pain-card">
        <span class="pain-icon">&#x1F4B8;</span>
        <h3>O custo real ultrapassa em muito a mensalidade base</h3>
        <p>O plano Starter do Mindbody parece razo&aacute;vel, mas o assistente de IA Messenger custa $75-$250/m&ecirc;s extras, o processamento de pagamentos chega a 3,60%+$0,30 por transa&ccedil;&atilde;o, e a comiss&atilde;o do marketplace &eacute; de 20% por agendamento. Para um sal&atilde;o movimentado, o custo total pode triplicar a mensalidade anunciada.</p>
      </div>

      <div class="pain-card">
        <span class="pain-icon">&#x1F4CA;</span>
        <h3>Comiss&atilde;o de 20% corroi a margem</h3>
        <p>Todo agendamento feito pelo marketplace do Mindbody custa 20% de comiss&atilde;o, com teto de $30 por cliente. Para um sal&atilde;o com 50 novos clientes por m&ecirc;s via marketplace, isso pode representar at&eacute; $1.500 em comiss&otilde;es &mdash; al&eacute;m da mensalidade. O Pronto cobra zero comiss&atilde;o em qualquer caso.</p>
      </div>

      <div class="pain-card">
        <span class="pain-icon">&#x1F4E8;</span>
        <h3>Sem lembretes por WhatsApp ou Telegram</h3>
        <p>O Mindbody envia notifica&ccedil;&otilde;es por e-mail e SMS &mdash; mas WhatsApp e Telegram n&atilde;o est&atilde;o dispon&iacute;veis nativamente. Para neg&oacute;cios fora dos EUA onde o WhatsApp &eacute; o canal de comunica&ccedil;&atilde;o principal, essa &eacute; uma lacuna significativa. O Pronto inclui WhatsApp, Telegram, Viber e E-mail sem custo adicional.</p>
      </div>
...
<section class="wins-section">
  <div class="wins-inner">
    <h2>Onde o Mindbody tem uma vantagem real</h2>
    <p class="wins-note">Uma an&aacute;lise honesta de onde o Mindbody realmente supera o Pronto.</p>
    <div class="wins-grid">

      <div class="wins-card">
        <h3>Marketplace forte no segmento fitness dos EUA</h3>
        <p>O Mindbody tem um dos maiores marketplaces de fitness e bem-estar dos EUA. Para grandes estúdios de yoga, pilates ou crossfit em cidades americanas, essa visibilidade pode gerar um fluxo significativo de novos clientes. O Pronto n&atilde;o tem marketplace &mdash; os clientes te encontram pelos seus pr&oacute;prios canais.</p>
      </div>

      <div class="wins-card">
        <h3>Funcionalidades avan&ccedil;adas para grandes est&uacute;dios</h3>
        <p>O Mindbody tem recursos robustos para gest&atilde;o de aulas em grupo, assinaturas, pacotes de sess&otilde;es e integra&ccedil;&atilde;o com wearables &mdash; funcionalidades que fazem sentido para grandes est&uacute;dios de fitness com centenas de alunos. O Pronto foca em ag&ecirc;ncias menores como sal&otilde;es, barbearias e cl&iacute;nicas.</p>
      </div>
    ...
    <div class="pricing-cols">
      ...
      <div class="pricing-card pronto">
        ...
        <ul class="pricing-list">
          ...
          <li>&#10003; Sem contratos &mdash; cancele quando quiser</li>
      ...
      <div class="pricing-card mindbody">
        ...
        <div class="pricing-highlight">~$99-$139/m&ecirc;s</div>
        <ul class="pricing-list">
          <li>&rarr; Starter: ~$99-$139/m&ecirc;s por local</li>
          <li>&rarr; Contrato de 12-24 meses obrigat&oacute;rio</li>
          <li>&rarr; Comiss&atilde;o marketplace: 20% (m&aacute;x. $30/cliente)</li>
          <li>&rarr; Processamento: 2,99%-3,60% + $0,30/transa&ccedil;&atilde;o</li>
          <li>&rarr; Messenger AI: add-on ~$75-$250/m&ecirc;s</li>
          <li>&rarr; Sem plano gratuito nem per&iacute;odo de teste</li>
        </ul>
        <p class="pricing-note-small">Verifique as tarifas atuais diretamente com a equipe de vendas do Mindbody.</p>
      </div>

    </div>
    <div class="example-box">
      <h3>Exemplo real</h3>
      <p>Um sal&atilde;o de m&eacute;dio porte no Mindbody paga: ~$139/m&ecirc;s de mensalidade + $250/m&ecirc;s de Messenger AI + 20% de comiss&atilde;o nos novos clientes via marketplace = facilmente $500+/m&ecirc;s antes do processamento de pagamentos. O plano Pro equivalente do Pronto custa $39/m&ecirc;s fixo &mdash; sem contrato, sem comiss&atilde;o, zero taxa por transa&ccedil;&atilde;o.</p>
    </div>
  </div>
</section>
...
<section class="faq-section">
  <div class="faq-inner">
    ...
    <div class="faq-item">
      <div class="faq-q">O Pronto &eacute; uma alternativa gratuita ao Mindbody?</div>
      <div class="faq-a">Sim. O Pronto tem um plano gratuito sem mensalidade e sem comiss&atilde;o. O Mindbody n&atilde;o oferece plano gratuito nem per&iacute;odo de teste &mdash; o plano Starter come&ccedil;a em aproximadamente $99-$139/m&ecirc;s por local, exigindo um contrato de 12 a 24 meses.</div>
    </div>

    <div class="faq-item">
      <div class="faq-q">O Mindbody cobra comiss&atilde;o?</div>
      <div class="faq-a">Sim. O Mindbody cobra 20% de comiss&atilde;o sobre agendamentos feitos pelo seu marketplace de consumidores, com um teto de $30 por cliente. O Pronto cobra zero comiss&atilde;o em qualquer caso &mdash; seja pelo SaaS em trypronto.app ou pela vers&atilde;o self-hosted.</div>
    </div>

    <div class="faq-item">
      <div class="faq-q">O Mindbody exige contrato?</div>
      <div class="faq-a">Sim. O Mindbody geralmente exige contratos anuais de 12 a 24 meses. Cancelar antes do t&eacute;rmino pode gerar multas. O Pronto n&atilde;o tem contratos &mdash; voc&ecirc; cancela a qualquer momento sem penalidade.</div>
    </div>

    <div class="faq-item">
      <div class="faq-q">Quanto custa o Mindbody por m&ecirc;s?</div>
      <div class="faq-a">O Mindbody Starter custa aproximadamente $99-$139/m&ecirc;s por local, com contrato anual. Funcionalidades avan&ccedil;adas como o assistente de IA Messenger custam $75-$250/m&ecirc;s adicionais. O processamento de pagamentos custa 2,99%-3,60%+$0,30 por transa&ccedil;&atilde;o. O Pronto come&ccedil;a em $0/m&ecirc;s &mdash; o plano Pro cobre 15 funcion&aacute;rios por $39/m&ecirc;s fixo.</div>
    </div>

    <div class="faq-item">
      <div class="faq-q">O Pronto tem notifica&ccedil;&otilde;es por WhatsApp como o Mindbody?</div>
      <div class="faq-a">O Mindbody n&atilde;o oferece notifica&ccedil;&otilde;es nativas por WhatsApp ou Telegram. O Pronto inclui notifica&ccedil;&otilde;es nativas por WhatsApp, Telegram, Viber e E-mail sem custo adicional: confirma&ccedil;&atilde;o de agendamento, lembrete 24h antes, lembrete 1h antes, mensagem p&oacute;s-visita e reativa&ccedil;&atilde;o de clientes.</div>
    </div>

    <div class="faq-item">
      <div class="faq-q">Existe uma alternativa self-hosted ao Mindbody?</div>
      <div class="faq-a">Sim. O Pronto &eacute; a &uacute;nica alternativa open-source e self-hosted ao Mindbody. Instale com um &uacute;nico comando no seu pr&oacute;prio servidor: docker compose up -d. Os dados dos seus clientes ficam no seu servidor &mdash; n&atilde;o na nuvem do Mindbody. O Pronto tem licen&ccedil;a MIT.</div>
    </div>

    <div class="faq-item">
      <div class="faq-q">Onde o Mindbody tem vantagem sobre o Pronto?</div>
      <div class="faq-a">O Mindbody tem um grande marketplace de consumidores, especialmente forte no segmento de fitness e bem-estar nos EUA, al&eacute;m de funcionalidades avan&ccedil;adas para est&uacute;dios como gest&atilde;o de aulas em grupo, assinaturas e integra&ccedil;&atilde;o com wearables. Para grandes est&uacute;dios de fitness que precisam dessas funcionalidades espec&iacute;ficas, o Mindbody pode valer o custo mais alto.</div>
    </div>

    <div class="faq-item">
      <div class="faq-q">Posso migrar do Mindbody para o Pronto?</div>
      <div class="faq-a">Sim. Exporte sua lista de clientes do Mindbody e importe para o CRM do Pronto. Voc&ecirc; pode usar os dois em paralelo durante a transi&ccedil;&atilde;o. O SaaS do Pronto em trypronto.app leva minutos para configurar, ou instale no seu pr&oacute;prio servidor com um &uacute;nico comando.</div>
    </div>
...
<section class="cta">
  <h2>Pronto para uma alternativa mais simples e barata ao Mindbody?</h2>
  <p>Come&ccedil;e gr&aacute;tis &mdash; sem contratos, sem comiss&atilde;o, sem complexidade.</p>
  <div class="cta-btns">
...
<footer>
  ...
  <div class="footer-bottom">
    ...
    <div class="footer-social">
      ...
      <a href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on GitHub" onclick="window.gtag&&window.gtag('event','github_click',{label:'footer_link',page:'/pt/vs/mindbody'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
    </div>
  </div>
</footer>
`

export default function PtVsMindbodyPage() {
  return (
    <>
      <script
