  ...
  return (
    <div className={`${styles.page} ${bricolage.variable} ${dmSans.variable}`}>
      ...
      {/* FOOTER — keep in sync with all other pages
          PT standard: /pt/ · /pt/precos · /pt/para · /pt/docs · legal */}
      <footer className={styles.footer}>
        <div className={styles.footerBrand}>
          Pronto<span>.</span>
        </div>
        <div className={styles.footerCopy}>© 2025 Pronto. Todos os direitos reservados.</div>
        <div className={styles.footerSocial}>
          ...
          <TrackedAnchor href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on GitHub" eventName="github_click" eventParams={{ label: 'footer_link', page: '/pt' }}>
