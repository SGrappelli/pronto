...
const softwareAppSchema = {
  ...
  name: 'Pronto — Fitness Club Management Software',
  url: 'https://trypronto.app/for/fitness',
  description:
    'Free open-source fitness club management software with class booking, member CRM, POS, inventory tracking and omnichannel notifications via Email, Telegram, WhatsApp and Viber.',
  applicationCategory: 'BusinessApplication',
  applicationSubCategory: 'Fitness Club Management Software',
  ...
  featureList: [
    'Fitness class and session booking',
    'Gym and studio POS system',
    'Member CRM with attendance history',
    'Supplement and gear inventory tracking',
    'Automated class reminders via Telegram and WhatsApp',
    'Online booking page — no member account required',
    'Trainer scheduling',
    'Revenue analytics',
    'PWA — works offline',
  ],
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'What is the best free fitness club management software?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Pronto is a free, open-source fitness club management software that includes class and session booking, a member CRM, POS, inventory tracking, and automated notifications via Email, Telegram, WhatsApp and Viber. The self-hosted version is free forever with no limits. The cloud version has a free tier and paid plans starting at $19/month.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can members book classes without creating an account?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No account required. The public booking page only needs a name and phone number. There is no registration, no password, and no app to download. This removes friction and increases class booking conversion compared to platforms that require account creation.',
      },
    },
    {
      '@type': 'Question',
      name: 'Is Pronto an alternative to gym booking platforms?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Unlike marketplace booking platforms that take a percentage of every class or session and lock your member data into their ecosystem, Pronto charges zero commission. You own your member database completely. You can also self-host the entire system on your own server — no vendor lock-in of any kind.',
      },
    },
    {
      '@type': 'Question',
      name: 'How do automated class reminders work for fitness clubs?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Pronto automatically sends a booking confirmation immediately after a class is booked, a reminder 24 hours before the session, another reminder 1 hour before, and a thank-you message 2 hours after the session ends. All messages are sent via the channels your member prefers: WhatsApp, Telegram, Viber or Email. No manual action needed from gym staff.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can I track supplement and gear inventory with Pronto?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Pronto tracks stock levels for every product in your gym — supplements, gear, merchandise. When a product drops below the minimum quantity you set, an alert is automatically sent to the owner via any configured notification channel: Email, Telegram, WhatsApp or Viber.',
      },
    },
    {
      '@type': 'Question',
      name: 'Does Pronto work for gyms, yoga studios and personal trainers?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Pronto is designed for any service business that takes bookings and sells services or products. It works for gyms, fitness studios, yoga studios, pilates studios, CrossFit boxes, martial arts schools, personal trainers, and any other fitness business.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You need Docker on any Linux VPS, Windows or macOS machine with at least 1 GB RAM. Run docker compose up -d and the full fitness club management system starts automatically. No DevOps knowledge required.',
      },
    },
    {
      '@type': 'Question',
      name: 'What happens to my member data if I cancel?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'With the self-hosted version, your data is always on your own server — nothing to cancel or lose. With the cloud version, you can export all member data and attendance history at any time. Your member base is never locked in the way it would be on a marketplace platform.',
      },
    },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Fitness clubs', item: 'https://trypronto.app/for/fitness' },
  ],
}
...
<section class="hero">
  <div class="hero-inner">
    ...
    <h1>Your gym. <em>Your members.</em> Zero commission.</h1>
    <p class="hero-sub">Free class booking, member CRM, POS and automated reminders &mdash; for gyms, fitness studios, yoga clubs and personal trainers. Self-hosted or cloud.</p>
    <p class="hero-platforms">Most booking platforms charge <strong>20&ndash;30%</strong> on every class or session from your own members. Pronto charges <strong>$0</strong>.</p>
    <div class="hero-ctas">
...
<section class="sec sec-warm">
  <div class="cards-wrap">
    <div class="problem-banner">
      <h3>The fitness software trap no one talks about</h3>
      <p>You&#39;ve built a loyal member base over years. Then a booking platform demands a <strong>20&ndash;30% cut</strong> on every class or session &mdash; from members who are already committed to your gym. Cancel your subscription and your booking history, member contacts, and attendance records disappear forever.</p>
    </div>
  </div>
  <div style="height:32px"></div>
  <div class="sec-head">
    <h2>What fitness club owners actually deal with</h2>
  ...
  <div class="cards-wrap">
    <div class="pain-grid">
      <div class="pain-card">
        ...
        <div class="pain-from-text">Booking platform takes 20% per class</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Members book directly &mdash; you keep 100%</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Manual WhatsApp reminders before every class</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Auto-reminders 24h and 1h before &mdash; via WhatsApp, Telegram, Email or Viber</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Members register on their platform, not yours</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Members book with just name &amp; phone &mdash; no app, no account</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Running out of supplements or gear mid-month</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Low-stock alert to your phone before you run out</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">No idea who&#39;s attending or spending</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Full member history &mdash; classes, spend, last visit, birthday</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Classes overbooked, scheduling chaos</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Database-level capacity check &mdash; impossible to overbook a class</div>
      </div>
    </div>
  </div>
</section>
...
<section class="sec sec-white">
  <div class="sec-head">
    <h2>Everything a fitness club needs, nothing it doesn&#39;t</h2>
    <p>Built for the person running the gym, not for enterprise IT teams.</p>
  </div>
  <div class="cards-wrap">
    <div class="feat-grid">
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4C5;</div>
        <h4>Class &amp; session booking</h4>
        <p>Drag-and-drop calendar. Week view. Trainer columns. Members book online without creating an account.</p>
        <div class="feat-detail">Capacity protection at database level &mdash; no overbooking possible</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4B3;</div>
        <h4>Point of sale</h4>
        <p>Memberships, drop-ins, supplements, gear. Complete a sale in 3 clicks. Cash, card, transfer.</p>
        <div class="feat-detail">Works fully offline &mdash; no internet needed at checkout</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F464;</div>
        <h4>Member CRM</h4>
        <p>Full profile per member: classes attended, total spend, membership type, notes, birthday, tags.</p>
        <div class="feat-detail">Search your entire member base in under 1 second</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4E6;</div>
        <h4>Inventory tracking</h4>
        <p>Track supplements, gear, merchandise. Log purchases and usage. Automatic low-stock alerts.</p>
        <div class="feat-detail">Alert sent via Telegram, WhatsApp, Email or Viber &mdash; your choice</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F310;</div>
        <h4>Online booking page</h4>
        <p>Public class schedule members can find and book from directly. No marketplace in the middle.</p>
        <div class="feat-detail">Name + phone only &mdash; no registration, no app to download</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4F1;</div>
        <h4>Works on any device</h4>
        <p>Install as a PWA on phone or tablet from the browser. Works offline at reception.</p>
        <div class="feat-detail">No App Store, no 30% Apple/Google cut on app purchases</div>
      </div>
    </div>
  </div>
</section>
...
<section class="sec sec-green">
  <div class="sec-head">
    <h2>How your fitness club runs on Pronto</h2>
    <p>From a new member to a loyal regular &mdash; fully automated.</p>
  </div>
  <div class="workflow">
    <div class="wf-step">
      <div class="wf-num">01</div>
      <div class="wf-title">Member discovers your class schedule</div>
      <div class="wf-desc">Linked from Instagram, Google, or anywhere. No app, no account &mdash; just name and phone.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">02</div>
      <div class="wf-title">Booking confirmed automatically</div>
      <div class="wf-desc">Instant confirmation sent via WhatsApp, Telegram, Email or Viber.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">03</div>
      <div class="wf-title">Reminders go out without you</div>
      <div class="wf-desc">24 hours and 1 hour before the class. No manual messages. Fewer no-shows.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">04</div>
      <div class="wf-title">Check out and<br>re-engage</div>
      <div class="wf-desc">Complete the sale at the POS. Thank-you sent automatically. Member added to your CRM forever.</div>
    </div>
  </div>
</section>
...
<section class="sec sec-blue">
  <div class="sec-head">
    <h2>Automated member reminders &mdash; on every channel</h2>
    <p>The only open-source fitness software with Email, Telegram, WhatsApp and Viber built in &mdash; no plugins, no paid add-ons.</p>
  </div>
  ...
  <div class="cards-wrap">
    <div class="notif-grid">
      <div class="notif-card">
        ...
        <div class="ev-text">Class booking confirmed</div>
        <div class="ev-sub">Sent immediately when member books online or when you add a booking manually</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x23F0;</div>
        <div class="ev-text">Session reminder</div>
        <div class="ev-sub">Automatic reminder 24 hours before and again 1 hour before the class</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F48C;</div>
        <div class="ev-text">Post-session thank you</div>
        <div class="ev-sub">Sent 2 hours after the class ends &mdash; keeps your gym top of mind</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F504;</div>
        <div class="ev-text">Re-activation message</div>
        <div class="ev-sub">&#x201C;We haven&#39;t seen you in 30 days&#x201D; &mdash; brings lapsed members back automatically</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F382;</div>
        <div class="ev-text">Birthday greeting</div>
        <div class="ev-sub">Auto-sent on the member&#39;s birthday &mdash; a personal touch that costs you nothing</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F4E6;</div>
...
<section class="sec sec-warm">
  <div class="sec-head">
    <h2>Why fitness club owners choose Pronto</h2>
    <p>How Pronto compares to typical gym booking platforms.</p>
  </div>
  ...
  <div style="text-align:center;margin-top:24px">
    <div class="badge-row">
      ...
      <span class="badge">Yoga studios</span>
      <span class="badge">Fitness studios</span>
      <span class="badge">Personal trainers</span>
      <span class="badge">CrossFit boxes</span>
      <span class="badge">Pilates studios</span>
...
<section class="sec sec-white">
  <div class="sec-head">
    <h2>Two ways to run Pronto for your fitness club</h2>
  ...
  <div class="two-paths">
    <div class="path-card self">
      ...
      <div class="path-points" style="margin-top:16px">
        <div class="path-point"><div class="path-point-dot"></div><div class="path-point-text"><strong>$0 forever</strong> &mdash; no subscription, no limits on members or trainers</div></div>
    ...
    <div class="path-card cloud">
      ...
      <p class="path-desc">No server needed. Get your studio&#39;s subdomain in 5 minutes. We handle everything.</p>
      <div class="path-points">
        <div class="path-point"><div class="path-point-dot"></div><div class="path-point-text"><strong>Your subdomain</strong> &mdash; fitness-zone.trypronto.app or custom domain on Pro+</div></div>
...
<section class="faq">
  <div class="faq-inner">
    ...
    <div class="faq-item">
      <div class="faq-q">What is the best free fitness club management software?</div>
      <div class="faq-a">Pronto is a free, open-source fitness club management software that includes class and session booking, a member CRM, POS, inventory tracking, and automated notifications via Email, Telegram, WhatsApp and Viber. The self-hosted version is free forever with no limits. The cloud version has a free tier and paid plans starting at $19/month.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Can members book classes without creating an account?</div>
      <div class="faq-a">No account required. The public booking page only needs a name and phone number. There is no registration, no password, and no app to download. This removes friction and increases class booking conversion compared to platforms that require account creation.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Is Pronto an alternative to gym booking platforms?</div>
      <div class="faq-a">Yes. Unlike marketplace booking platforms that take a percentage of every class or session and lock your member data into their ecosystem, Pronto charges zero commission. You own your member database completely. You can also self-host the entire system on your own server &mdash; no vendor lock-in of any kind.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">How do automated class reminders work for fitness clubs?</div>
      <div class="faq-a">Pronto automatically sends a booking confirmation immediately after a class is booked, a reminder 24 hours before the session, another reminder 1 hour before, and a thank-you message 2 hours after the session ends. All messages are sent via the channels your member prefers: WhatsApp, Telegram, Viber or Email. No manual action needed from gym staff.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Can I track supplement and gear inventory with Pronto?</div>
      <div class="faq-a">Yes. Pronto tracks stock levels for every product in your gym &mdash; supplements, gear, merchandise. When a product drops below the minimum quantity you set, an alert is automatically sent to the owner via any configured notification channel: Email, Telegram, WhatsApp or Viber.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Does Pronto work for gyms, yoga studios and personal trainers?</div>
      <div class="faq-a">Yes. Pronto is designed for any service business that takes bookings and sells services or products. It works for gyms, fitness studios, yoga studios, pilates studios, CrossFit boxes, martial arts schools, personal trainers, and any other fitness business.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">How do I install Pronto on my own server?</div>
      <div class="faq-a">You need Docker on any Linux VPS, Windows or macOS machine with at least 1 GB RAM. Run <code>docker compose up -d</code> and the full fitness club management system starts automatically. No DevOps knowledge required. See the <a href="https://github.com/SGrappelli/pronto" style="color:#3b82f6;text-decoration:none">documentation on GitHub</a> for step-by-step instructions.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">What happens to my member data if I cancel?</div>
      <div class="faq-a">With the self-hosted version, your data is always on your own server &mdash; nothing to cancel or lose. With the cloud version, you can export all member data and attendance history at any time. Your member base is never locked in the way it would be on a marketplace platform.</div>
    </div>
  </div>
</section>
...
<section class="cta-band">
  <h2>Start managing your fitness club for free</h2>
...
<footer>
  ...
  <div class="footer-bottom">
    ...
    <div class="footer-social">
      <a href="https://x.com/prontopos" target="_blank" rel="noopener noreferrer" aria-label="Pronto on X" onclick="window.gtag&&window.gtag('event','social_click',{platform:'twitter',page:'/for/fitness'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.76l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
      <a href="https://www.linkedin.com/in/konstantinumnov/" target="_blank" rel="noopener noreferrer" aria-label="Pronto on LinkedIn" onclick="window.gtag&&window.gtag('event','social_click',{platform:'linkedin',page:'/for/fitness'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a>
      <a href="https://www.youtube.com/@trypronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on YouTube" onclick="window.gtag&&window.gtag('event','social_click',{platform:'youtube',page:'/for/fitness'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
      <a href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on GitHub" onclick="window.gtag&&window.gtag('event','github_click',{label:'footer_link',page:'/for/fitness'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
    </div>
  </div>
</footer>
`
