...
<nav>
  ...
  <div class="nav-right">
    ...
    <a href="/es/para/salones" class="nav-link lang-switcher" onclick="window.gtag&&window.gtag('event','language_switch',{to:'es'})">ES</a>
...
<section class="sec sec-white">
  ...
  <div class="plans">
    <div class="plan">
      ...
      <div class="plan-limit">1 employee &middot; 100 clients</div>
      <ul class="plan-feats">
    ...
    <div class="plan">
      ...
      <div class="plan-limit">3 employees &middot; 1 000 clients</div>
      <ul class="plan-feats">
...
<footer>
  ...
  <div class="footer-links">
    ...
    <a href="https://github.com/SGrappelli/pronto" onclick="window.gtag&&window.gtag('event','github_click',{label:'footer_link',page:'/for/salons'})">GitHub</a>
  </div>
</footer>
`
