...
const softwareAppSchema = {
  ...
  name: 'Pronto — Salon Management Software',
  url: 'https://trypronto.app/for/salons',
  description:
    'Free open-source salon management software with POS, appointment booking, CRM, inventory tracking and omnichannel client notifications via Email, Telegram, WhatsApp and Viber.',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'What is the best free salon management software?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Pronto is a free, open-source salon management software that includes a POS, appointment booking calendar, client CRM, inventory tracking, and automated notifications via Email, Telegram, WhatsApp and Viber. The self-hosted version is free forever with no limits. The cloud version has a free tier and paid plans starting at $19/month.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do clients have to create an account to book an appointment?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No. The public booking page only requires a name and phone number. There is no registration, no password, and no app to download. This removes friction and increases booking conversion significantly compared to platforms that require account creation.',
      },
    },
    {
      '@type': 'Question',
      name: 'Is Pronto an alternative to salon booking platforms?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Unlike marketplace booking platforms that take a percentage of every appointment and lock your client data into their ecosystem, Pronto charges zero commission. You own your client database completely. If you stop using Pronto, your data is yours. You can also self-host the entire system on your own server — no vendor lock-in of any kind.',
      },
    },
    {
      '@type': 'Question',
      name: 'How do automated appointment reminders work for salons?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Pronto automatically sends a booking confirmation immediately after an appointment is made, a reminder 24 hours before the visit, another reminder 1 hour before, and a thank-you message 2 hours after the visit ends. All messages are sent via the channels your client prefers: WhatsApp, Telegram, Viber or Email. No manual action needed from salon staff.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can I track salon product inventory and get low-stock alerts?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Pronto tracks stock levels for every product in your salon. When a product drops below the minimum quantity you set, an alert is automatically sent to the salon owner via any configured notification channel — Email, Telegram, WhatsApp or Viber.',
      },
    },
    {
      '@type': 'Question',
      name: 'Does Pronto work for hair salons, nail salons and barbershops?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Pronto is designed for any service business that takes appointments and sells services or products. It works for hair salons, beauty salons, nail salons, barbershops, massage and spa studios, lash studios, tattoo studios, and more.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You need Docker on any Linux VPS, Windows or macOS machine with at least 1 GB RAM. Run docker compose up -d and the full salon management system starts automatically. No DevOps knowledge required.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'With the self-hosted version, your data is always on your own server — nothing to cancel or lose. With the cloud version, you can export all client data and history at any time. Your client base is never locked in the way it would be on a marketplace platform.',
      },
    },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Salons & beauty', item: 'https://trypronto.app/for/salons' },
  ],
}
...
<section class="hero">
  <div class="hero-inner">
    ...
    <h1>Your salon. <em>Your clients.</em> Zero commission.</h1>
...
<section class="sec sec-warm">
  <div class="cards-wrap">
    <div class="problem-banner">
      <h3>The salon software problem nobody talks about</h3>
      <p>You built a loyal client base over years. Then a booking platform claims a <strong>20&ndash;30% cut</strong> of every appointment &mdash; from clients who are already yours. Worse: they own the data. Cancel your account and your booking history, client contacts, and reviews disappear.</p>
    </div>
  </div>
  <div style="height:32px"></div>
  <div class="sec-head">
    <h2>What salon owners actually deal with</h2>
  ...
  <div class="cards-wrap">
    <div class="pain-grid">
      <div class="pain-card">
        ...
        <div class="pain-from-text">Booking platform takes 20% per appointment</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Clients book directly &mdash; you keep 100%</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Manual WhatsApp reminders every evening</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Auto-reminders 24h and 1h before &mdash; via WhatsApp, Telegram, Email or Viber</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Client registers on their platform, not yours</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Clients book with just name &amp; phone &mdash; no app, no account</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Running out of shampoo mid-week</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Low-stock alert to your phone before you run out</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">No idea who&#39;s been coming in or spending</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Full client history &mdash; visits, spend, last seen, birthday</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Double bookings, paper calendar mistakes</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Database-level conflict check &mdash; impossible to double-book a slot</div>
      </div>
    </div>
  </div>
</section>
...
<section class="sec sec-white">
  <div class="sec-head">
    <h2>Everything a salon needs, nothing it doesn&#39;t</h2>
    <p>Built for the person running the salon, not for enterprise IT teams.</p>
  </div>
  <div class="cards-wrap">
    <div class="feat-grid">
      <div class="feat-card">
        ...
        <p>Drag-and-drop calendar. Week view. Staff columns. Clients book online without creating an account.</p>
        <div class="feat-detail">Conflict protection at database level &mdash; no double bookings possible</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4B3;</div>
        <h4>Point of sale</h4>
        <p>Complete a sale in 3 clicks. Cash, card, transfer. Apply discounts. Print or send digital receipts.</p>
        <div class="feat-detail">Works fully offline &mdash; no internet needed at checkout</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F464;</div>
        <h4>Client CRM</h4>
        <p>Full history per client: visits, services, products bought, total spend, notes, birthday, tags.</p>
        <div class="feat-detail">Search across your entire client base in under 1 second</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4E6;</div>
        <h4>Inventory tracking</h4>
        <p>Track every product on your shelf. Log purchases and usage. Automatic low-stock alerts.</p>
        <div class="feat-detail">Alert sent via Telegram, WhatsApp, Email or Viber &mdash; your choice</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F310;</div>
        <h4>Online booking page</h4>
        <p>Public page clients can find and book from directly. No third-party marketplace in the middle.</p>
        <div class="feat-detail">Name + phone only &mdash; no registration, no app to download</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4F1;</div>
        <h4>Works on any device</h4>
        <p>Install as a PWA on your phone or tablet directly from the browser. Works offline at the desk.</p>
...
<section class="sec sec-green">
  <div class="sec-head">
    <h2>How your salon runs on Pronto</h2>
    <p>From a new client to a repeat booking &mdash; fully automated.</p>
  </div>
  <div class="workflow">
    <div class="wf-step">
      <div class="wf-num">01</div>
      <div class="wf-title">Client discovers your booking page</div>
    ...
    <div class="wf-step">
      ...
      <div class="wf-desc">Instant confirmation sent to the client via WhatsApp, Telegram, Email or Viber.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">03</div>
      <div class="wf-title">Reminders go out without you</div>
      <div class="wf-desc">24 hours and 1 hour before the appointment. No manual messages. No no-shows.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">04</div>
      <div class="wf-title">Checkout and<br>re-engage</div>
      <div class="wf-desc">Complete the sale at the POS. Thank-you sent automatically. Client added to your CRM forever.</div>
    </div>
  </div>
</section>
...
<section class="sec sec-blue">
  <div class="sec-head">
    ...
    <p>The only open-source salon software with Email, Telegram, WhatsApp and Viber built in &mdash; no plugins, no paid add-ons.</p>
  </div>
  ...
  <div class="cards-wrap">
    <div class="notif-grid">
      <div class="notif-card">
        ...
        <div class="ev-sub">Sent immediately when client books online or when you add a booking manually</div>
      ...
      <div class="notif-card">
        ...
        <div class="ev-sub">Sent 2 hours after the visit ends &mdash; keeps your salon top of mind</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F504;</div>
        <div class="ev-text">Re-activation message</div>
        <div class="ev-sub">&#x201C;We haven&#39;t seen you in 30 days&#x201D; &mdash; brings lapsed clients back automatically</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F382;</div>
        <div class="ev-text">Birthday greeting</div>
        <div class="ev-sub">Auto-sent on the client&#39;s birthday &mdash; a personal touch that costs you nothing</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F4E6;</div>
...
<section class="sec sec-warm">
  <div class="sec-head">
    <h2>Why salon owners choose Pronto</h2>
    <p>How Pronto compares to typical salon booking platforms.</p>
  </div>
  ...
  <div style="text-align:center;margin-top:24px">
    <div class="badge-row">
      <span class="badge">Beauty salons</span>
      <span class="badge">Hair salons</span>
      <span class="badge">Nail salons</span>
      <span class="badge">Barbershops</span>
      <span class="badge">Massage &amp; spa</span>
      <span class="badge">Lash studios</span>
...
<section class="sec sec-white">
  <div class="sec-head">
    <h2>Two ways to run Pronto for your salon</h2>
  ...
  <div class="two-paths">
    <div class="path-card self">
      ...
      <div class="path-points" style="margin-top:16px">
        <div class="path-point"><div class="path-point-dot"></div><div class="path-point-text"><strong>$0 forever</strong> &mdash; no subscription, no limits on clients or staff</div></div>
      ...
      <a href="https://github.com/SGrappelli/pronto" class="btn-outline" style="margin-right:10px" onclick="window.gtag&&window.gtag('event','github_click',{label:'cta_button',page:'/for/salons'})">View on GitHub &rarr;</a>
    ...
    <div class="path-card cloud">
      ...
      <p class="path-desc">No server needed. Get your salon&#39;s subdomain in 5 minutes. We handle everything.</p>
...
<section class="faq">
  <div class="faq-inner">
    ...
    <div class="faq-item">
      <div class="faq-q">What is the best free salon management software?</div>
      <div class="faq-a">Pronto is a free, open-source salon management software that includes a POS, appointment booking calendar, client CRM, inventory tracking, and automated notifications via Email, Telegram, WhatsApp and Viber. The self-hosted version is free forever with no limits. The cloud version has a free tier and paid plans starting at $19/month.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Do clients have to create an account to book an appointment?</div>
      <div class="faq-a">No. The public booking page only requires a name and phone number. There is no registration, no password, and no app to download. This removes friction and increases booking conversion significantly compared to platforms that require account creation.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Is Pronto an alternative to salon booking platforms?</div>
      <div class="faq-a">Yes. Unlike marketplace booking platforms that take a percentage of every appointment and lock your client data into their ecosystem, Pronto charges zero commission. You own your client database completely. If you stop using Pronto, your data is yours. You can also self-host the entire system on your own server &mdash; no vendor lock-in of any kind.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">How do automated appointment reminders work for salons?</div>
      <div class="faq-a">Pronto automatically sends a booking confirmation immediately after an appointment is made, a reminder 24 hours before the visit, another reminder 1 hour before, and a thank-you message 2 hours after the visit ends. All messages are sent via the channels your client prefers: WhatsApp, Telegram, Viber or Email. No manual action needed from salon staff.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Can I track salon product inventory and get low-stock alerts?</div>
      <div class="faq-a">Yes. Pronto tracks stock levels for every product in your salon. When a product drops below the minimum quantity you set, an alert is automatically sent to the salon owner via any configured notification channel &mdash; Email, Telegram, WhatsApp or Viber.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Does Pronto work for hair salons, nail salons and barbershops?</div>
      <div class="faq-a">Yes. Pronto is designed for any service business that takes appointments and sells services or products. It works for hair salons, beauty salons, nail salons, barbershops, massage and spa studios, lash studios, tattoo studios, and more.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">How do I install Pronto on my own server?</div>
      <div class="faq-a">You need Docker on any Linux VPS, Windows or macOS machine with at least 1 GB RAM. Run <code>docker compose up -d</code> and the full salon management system starts automatically. No DevOps knowledge required. See the <a href="https://github.com/SGrappelli/pronto" style="color:#3b82f6;text-decoration:none">documentation on GitHub</a> for step-by-step instructions.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">What happens to my data if I cancel?</div>
      <div class="faq-a">With the self-hosted version, your data is always on your own server &mdash; nothing to cancel or lose. With the cloud version, you can export all client data and history at any time. Your client base is never locked into Pronto the way it would be on a marketplace platform.</div>
    </div>
  </div>
</section>
...
<footer>
  ...
  <div class="footer-bottom">
    ...
    <div class="footer-social">
      <a href="https://x.com/prontopos" target="_blank" rel="noopener noreferrer" aria-label="Pronto on X" onclick="window.gtag&&window.gtag('event','social_click',{platform:'twitter',page:'/for/salons'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.76l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
      <a href="https://www.linkedin.com/in/konstantinumnov/" target="_blank" rel="noopener noreferrer" aria-label="Pronto on LinkedIn" onclick="window.gtag&&window.gtag('event','social_click',{platform:'linkedin',page:'/for/salons'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a>
      <a href="https://www.youtube.com/@trypronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on YouTube" onclick="window.gtag&&window.gtag('event','social_click',{platform:'youtube',page:'/for/salons'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
      <a href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on GitHub" onclick="window.gtag&&window.gtag('event','github_click',{label:'footer_link',page:'/for/salons'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
    </div>
  </div>
</footer>
`
