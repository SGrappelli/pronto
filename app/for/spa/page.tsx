...
const softwareAppSchema = {
  ...
  name: 'Pronto — Massage & Spa Management Software',
  url: 'https://trypronto.app/for/spa',
  description:
    'Free open-source massage and spa management software with appointment booking, client CRM, POS, product inventory and omnichannel notifications via Email, Telegram, WhatsApp and Viber.',
  ...
  featureList: [
    'Spa appointment and treatment booking',
    'Massage studio POS system',
    'Client CRM with treatment history',
    'Product and supply inventory tracking',
    'Automated appointment reminders via Telegram and WhatsApp',
    'Online booking page — no client account required',
    'Therapist scheduling and calendar',
    'Revenue analytics',
    'PWA — works offline',
  ],
}
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'What is the best free massage and spa management software?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Pronto is a free, open-source spa management software that includes appointment booking, a client CRM, POS, product inventory, and automated notifications via Email, Telegram, WhatsApp and Viber. The self-hosted version is free forever with no limits. The cloud version has a free tier and paid plans starting at $19/month.',
      },
    },
    {
      '@type': 'Question',
      name: 'Do spa clients need to create an account to book a treatment?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No. The public booking page only requires a name and phone number. There is no registration, no password, and no app to download. This reduces friction at the moment a client decides to book and increases conversion rates significantly compared to platforms that require account creation.',
      },
    },
    {
      '@type': 'Question',
      name: 'Is Pronto an alternative to spa booking platforms?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Unlike marketplace booking platforms that charge a percentage on every treatment and keep your client data locked in their system, Pronto charges zero commission. You own your client database completely. If you ever stop using Pronto, your data is yours. Self-hosting the entire system on your own server is also an option — no vendor lock-in of any kind.',
      },
    },
    {
      '@type': 'Question',
      name: 'How do automated appointment reminders work for spas and massage studios?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Pronto automatically sends a booking confirmation immediately after a treatment is booked, a reminder 24 hours before the appointment, another reminder 1 hour before, and a thank-you message 2 hours after the session ends. All messages go out via the channel your client prefers: WhatsApp, Telegram, Viber or Email. Spa staff don\'t need to send anything manually.',
      },
    },
    {
      '@type': 'Question',
      name: 'Can I track spa product inventory and get low-stock alerts?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Pronto tracks every product in your spa — oils, creams, candles, retail products. When any item drops below the minimum quantity you set, an alert is automatically sent to the owner via any configured channel: Email, Telegram, WhatsApp or Viber.',
      },
    },
    {
      '@type': 'Question',
      name: 'Does Pronto work for massage therapists, day spas and wellness centers?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. Pronto is built for any service business that takes appointments and sells services or products. It works for massage therapy studios, day spas, wellness centers, beauty spas, float therapy centers, lymphatic drainage studios, and any other spa or bodywork business.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'You need Docker on any Linux VPS, Windows or macOS machine with at least 1 GB RAM. Run docker compose up -d and the full spa management system starts automatically. No DevOps knowledge required.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'With the self-hosted version, your data is always on your own server — nothing to cancel or lose. With the cloud version, you can export all client data and treatment history at any time. Your client base is never held hostage the way it would be on a marketplace platform.',
      },
    },
  ],
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Massage & spa', item: 'https://trypronto.app/for/spa' },
  ],
}
...
<section class="hero">
  <div class="hero-inner">
    <div class="hero-eyebrow">
      ...
      Massage &amp; spa management software
    </div>
    <h1>Your spa. <em>Your clients.</em> Zero commission.</h1>
    <p class="hero-sub">Free appointment booking, client CRM, POS and automated treatment reminders &mdash; for massage studios, day spas, wellness centers and beauty spas. Self-hosted or cloud.</p>
    <p class="hero-platforms">Most booking platforms quietly take <strong>20&ndash;30%</strong> from every treatment booked through your own clients. Pronto takes <strong>$0</strong>.</p>
    <div class="hero-ctas">
...
<section class="sec sec-warm">
  <div class="cards-wrap">
    <div class="problem-banner">
      <h3>The spa software problem that quietly drains your revenue</h3>
      <p>Your clients chose you because of your skill and your space. Then a booking platform inserts itself between you and them &mdash; charging <strong>20&ndash;30%</strong> per treatment, forever. Cancel your account and the entire client history you built disappears with it. Your regulars, their preferences, their visit records &mdash; gone.</p>
    </div>
  </div>
  <div style="height:32px"></div>
  <div class="sec-head">
    <h2>What spa and massage business owners deal with every week</h2>
    <p>Every friction point below has a direct solution in Pronto.</p>
  </div>
  <div class="cards-wrap">
    <div class="pain-grid">
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Booking platform takes 20&ndash;30% per treatment</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Clients book directly with you &mdash; you keep every dollar</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Manually texting clients the night before each appointment</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Auto-reminders 24h and 1h before &mdash; via WhatsApp, Telegram, Email or Viber</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Client has to register on the platform&#39;s app to book</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Name and phone number only &mdash; no app, no password, no friction</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Running out of oils or creams mid-week</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Low-stock alert to your phone before you run out</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">No record of which treatments each client prefers</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Full client history &mdash; treatments, spend, preferences, birthday, last visit</div>
      </div>
      <div class="pain-card">
        <div class="pain-from-label">From</div>
        <div class="pain-from-text">Double-booked therapist, awkward conversation with the client</div>
        <div class="pain-arrow">&darr;</div>
        <div class="pain-to">Database-level conflict check &mdash; physically impossible to double-book a therapist</div>
      </div>
    </div>
  </div>
</section>
...
<section class="sec sec-white">
  <div class="sec-head">
    <h2>Everything a spa needs, nothing it doesn&#39;t</h2>
    <p>Designed for the person who runs the spa, not for a software department.</p>
  </div>
  <div class="cards-wrap">
    <div class="feat-grid">
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4C5;</div>
        <h4>Treatment booking calendar</h4>
        <p>Drag-and-drop week view. Therapist columns. Clients book online without creating an account or downloading anything.</p>
        <div class="feat-detail">No double-bookings &mdash; enforced at database level, not just in the UI</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4B3;</div>
        <h4>Point of sale</h4>
        <p>Sell treatments, packages, retail products and gift cards. Complete a transaction in 3 clicks. Cash, card, transfer.</p>
        <div class="feat-detail">Works fully offline &mdash; no internet needed at the reception desk</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F464;</div>
        <h4>Client profiles</h4>
        <p>Every client has a full profile: treatments received, products bought, total spend, notes, birthday, pressure and scent preferences.</p>
        <div class="feat-detail">Find any client across your entire database in under 1 second</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4E6;</div>
        <h4>Product inventory</h4>
        <p>Track oils, creams, candles, retail stock. Log deliveries and usage. Never run out without warning.</p>
        <div class="feat-detail">Low-stock alert delivered via Telegram, WhatsApp, Email or Viber</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F310;</div>
        <h4>Online booking page</h4>
        <p>A public page where clients can browse your treatments and book directly. No third-party marketplace taking a cut.</p>
        <div class="feat-detail">Name + phone only &mdash; books in under 60 seconds</div>
      </div>
      <div class="feat-card">
        <div class="feat-card-icon">&#x1F4F1;</div>
        <h4>Works on any device</h4>
        <p>Install as a PWA on your phone or tablet straight from the browser. Works offline at the front desk.</p>
        <div class="feat-detail">No App Store, no 30% platform fee on purchases</div>
      </div>
    </div>
  </div>
</section>
...
<section class="sec sec-green">
  <div class="sec-head">
    <h2>How a spa visit flows in Pronto &mdash; start to finish</h2>
    <p>From first booking to loyal regular &mdash; every step automated.</p>
  </div>
  <div class="workflow">
    <div class="wf-step">
      <div class="wf-num">01</div>
      <div class="wf-title">Client finds your booking page</div>
      <div class="wf-desc">Shared via Instagram bio, Google listing, or a QR code in your window. No app, no account &mdash; name and phone, done.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">02</div>
      <div class="wf-title">Confirmation sent instantly</div>
      <div class="wf-desc">Client receives a booking confirmation via WhatsApp, Telegram, Email or Viber &mdash; whichever they use.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">03</div>
      <div class="wf-title">Reminders go out automatically</div>
      <div class="wf-desc">24 hours and 1 hour before the treatment. No manual messages from your team. Significantly fewer no-shows.</div>
    </div>
    <div class="wf-step">
      <div class="wf-num">04</div>
      <div class="wf-title">Checkout and stay in touch</div>
      <div class="wf-desc">Complete the sale at the POS. Thank-you message sent 2 hours later. Client profile saved permanently to your CRM.</div>
    </div>
  </div>
</section>
...
<section class="sec sec-blue">
  <div class="sec-head">
    <h2>Automated client reminders across every channel</h2>
    <p>The only open-source spa software with Email, Telegram, WhatsApp and Viber built in natively &mdash; no plugins, no expensive add-ons.</p>
  </div>
  ...
  <div class="cards-wrap">
    <div class="notif-grid">
      <div class="notif-card">
        ...
        <div class="ev-text">Treatment confirmed</div>
        <div class="ev-sub">Sent immediately when a client books online or when your team adds a booking manually</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x23F0;</div>
        <div class="ev-text">Appointment reminder</div>
        <div class="ev-sub">Sent 24 hours before and again 1 hour before the treatment &mdash; quietly cuts your no-show rate</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F48C;</div>
        <div class="ev-text">Post-treatment thank you</div>
        <div class="ev-sub">Sent 2 hours after the session ends &mdash; a warm close that keeps your spa in the client&#39;s mind</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F504;</div>
        <div class="ev-text">Re-engagement message</div>
        <div class="ev-sub">&#x201C;We&#39;d love to see you again&#x201D; &mdash; sent automatically after 30 days of inactivity</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F382;</div>
        <div class="ev-text">Birthday message</div>
        <div class="ev-sub">A personal touch delivered automatically on the client&#39;s birthday &mdash; costs you nothing, means a lot</div>
        <div class="ev-channels">WhatsApp &middot; Telegram &middot; Email &middot; Viber</div>
      </div>
      <div class="notif-card">
        <div class="ev-emoji">&#x1F4E6;</div>
        <div class="ev-text">Low stock alert</div>
        <div class="ev-sub">Sent to the owner the moment any product drops below your set minimum</div>
...
<section class="sec sec-warm">
  <div class="sec-head">
    <h2>Why spa owners choose Pronto over booking platforms</h2>
    <p>An honest comparison between Pronto and the platforms that profit from your client relationships.</p>
  </div>
  ...
  <div style="text-align:center;margin-top:24px">
    <div class="badge-row">
      <span class="badge">Massage studios</span>
      <span class="badge">Day spas</span>
      <span class="badge">Wellness centers</span>
      <span class="badge">Beauty spas</span>
      <span class="badge">Float therapy</span>
      <span class="badge">Lymphatic drainage</span>
      <span class="badge">Bodywork studios</span>
    </div>
  </div>
</section>
...
<section class="sec sec-white">
  <div class="sec-head">
    <h2>Two ways to run Pronto for your spa</h2>
    <p>Full control with self-hosting, or be live in 5 minutes with our cloud.</p>
  </div>
  <div class="two-paths">
    <div class="path-card self">
      <div class="path-label">Option 1</div>
      <h3>Self-hosted</h3>
      <p class="path-desc">Deploy on your own server. Client data never leaves your machine. Free forever. Requires Docker.</p>
      <div class="code-block"><span class="code-prefix">$</span>docker compose up -d</div><br>
      <div class="path-points" style="margin-top:16px">
        <div class="path-point"><div class="path-point-dot"></div><div class="path-point-text"><strong>$0 forever</strong> &mdash; no subscription, no limits on clients or therapists</div></div>
    ...
    <div class="path-card cloud">
      ...
      <p class="path-desc">No server needed. Get your spa&#39;s subdomain in 5 minutes. We handle updates, backups, and uptime.</p>
      <div class="path-points">
        <div class="path-point"><div class="path-point-dot"></div><div class="path-point-text"><strong>Your subdomain</strong> &mdash; serenity-spa.trypronto.app or custom domain on Pro+</div></div>
...
<section class="faq">
  <div class="faq-inner">
    ...
    <div class="faq-item">
      <div class="faq-q">What is the best free massage and spa management software?</div>
      <div class="faq-a">Pronto is a free, open-source spa management software that includes appointment booking, a client CRM, POS, product inventory, and automated notifications via Email, Telegram, WhatsApp and Viber. The self-hosted version is free forever with no limits. The cloud version has a free tier and paid plans starting at $19/month.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Do spa clients need to create an account to book a treatment?</div>
      <div class="faq-a">No. The public booking page only requires a name and phone number. There is no registration, no password, and no app to download. This reduces friction at the moment a client decides to book and increases conversion rates significantly compared to platforms that require account creation.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Is Pronto an alternative to spa booking platforms?</div>
      <div class="faq-a">Yes. Unlike marketplace booking platforms that charge a percentage on every treatment and keep your client data locked in their system, Pronto charges zero commission. You own your client database completely. If you ever stop using Pronto, your data is yours. Self-hosting the entire system on your own server is also an option &mdash; no vendor lock-in of any kind.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">How do automated appointment reminders work for spas and massage studios?</div>
      <div class="faq-a">Pronto automatically sends a booking confirmation immediately after a treatment is booked, a reminder 24 hours before the appointment, another reminder 1 hour before, and a thank-you message 2 hours after the session ends. All messages go out via the channel your client prefers: WhatsApp, Telegram, Viber or Email. Spa staff don&#39;t need to send anything manually.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Can I track spa product inventory and get low-stock alerts?</div>
      <div class="faq-a">Yes. Pronto tracks every product in your spa &mdash; oils, creams, candles, retail products. When any item drops below the minimum quantity you set, an alert is automatically sent to the owner via any configured channel: Email, Telegram, WhatsApp or Viber.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">Does Pronto work for massage therapists, day spas and wellness centers?</div>
      <div class="faq-a">Yes. Pronto is built for any service business that takes appointments and sells services or products. It works for massage therapy studios, day spas, wellness centers, beauty spas, float therapy centers, lymphatic drainage studios, and any other spa or bodywork business.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">How do I install Pronto on my own server?</div>
      <div class="faq-a">You need Docker on any Linux VPS, Windows or macOS machine with at least 1 GB RAM. Run <code>docker compose up -d</code> and the full spa management system starts automatically. No DevOps knowledge required. See the <a href="https://github.com/SGrappelli/pronto" style="color:#3b82f6;text-decoration:none">documentation on GitHub</a> for step-by-step instructions.</div>
    </div>
    <div class="faq-item">
      <div class="faq-q">What happens to my client data if I cancel?</div>
      <div class="faq-a">With the self-hosted version, your data is always on your own server &mdash; nothing to cancel or lose. With the cloud version, you can export all client data and treatment history at any time. Your client base is never held hostage the way it would be on a marketplace platform.</div>
    </div>
  </div>
</section>
...
<section class="cta-band">
  <h2>Start managing your spa for free</h2>
  <p>Cloud setup takes 5 minutes. Self-hosted is one command. Either way &mdash; zero commission on every treatment, forever.</p>
  <div>
...
<footer>
  <div class="footer-top">
    ...
    <div class="footer-col">
      ...
      <a href="/for/salons">Hair salons</a>
  ...
  <div class="footer-bottom">
    ...
    <div class="footer-social">
      <a href="https://x.com/prontopos" target="_blank" rel="noopener noreferrer" aria-label="Pronto on X" onclick="window.gtag&&window.gtag('event','social_click',{platform:'twitter',page:'/for/spa'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.76l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></a>
      <a href="https://www.linkedin.com/in/konstantinumnov/" target="_blank" rel="noopener noreferrer" aria-label="Pronto on LinkedIn" onclick="window.gtag&&window.gtag('event','social_click',{platform:'linkedin',page:'/for/spa'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a>
      <a href="https://www.youtube.com/@trypronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on YouTube" onclick="window.gtag&&window.gtag('event','social_click',{platform:'youtube',page:'/for/spa'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
      <a href="https://github.com/SGrappelli/pronto" target="_blank" rel="noopener noreferrer" aria-label="Pronto on GitHub" onclick="window.gtag&&window.gtag('event','github_click',{label:'footer_link',page:'/for/spa'})"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg></a>
    </div>
  </div>
</footer>
`
